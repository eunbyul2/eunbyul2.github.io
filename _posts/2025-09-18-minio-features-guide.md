...
tags: [minio, object-storage, s3-compatible, kubernetes, operator, helm, mc, kes, replication, active-active-replication, ilm, object-lock, kms, sse-kms, sse-s3, tls, iam, observability, prometheus, grafana, monitoring, performance, best-practices]
published: true
---
...
- Erasure Coding: https://min.io/docs/minio/windows/operations/concepts/erasure-coding.html
- Healing/Scanner: https://min.io/docs/minio/macos/operations/concepts/scanner.html
- 컨테이너 배포(포트 예시 9000/9001): https://min.io/docs/minio/container/installation/deploy-minio-as-a-container.html <!-- if path changes, search "Deploy MinIO as a Container" -->
...
- 복제 요구사항: https://min.io/docs/minio/kubernetes/openshift/administration/bucket-replication/bucket-replication-requirements.html
- 일방향 규칙 추가: https://min.io/docs/minio/kubernetes/openshift/administration/bucket-replication/enable-server-side-one-way-bucket-replication.html
- 양방향 튜토리얼: https://min.io/docs/minio/kubernetes/gke/administration/bucket-replication/enable-server-side-two-way-bucket-replication.html
- 원격 재동기화: https://min.io/docs/minio/kubernetes/upstream/administration/bucket-replication/server-side-replication-resynchronize-remote.html
...
- ILM 개요(리눅스): https://min.io/docs/minio/linux/administration/object-management/object-lifecycle-management.html
- S3 전환 튜토리얼(컨테이너 예시): https://min.io/docs/minio/container/administration/object-management/transition-objects-to-s3.html
...
- Object Locking (Object Retention): https://min.io/docs/minio/macos/administration/object-management/object-retention.html  
  (플랫폼 경로가 macOS로 표기되어도 개념/명령은 동일. 환경별 세부 옵션은 해당 OS 페이지 참조.)
...
- 모니터링(개요): https://min.io/docs/minio/kubernetes/aks/administration/monitoring.html
...
- `mc sql`: (문서 UI 구조상 OS별 레퍼런스 경로를 검색해 사용)
...
- K8s(OpenShift) 노출 예시/Route: 복제 요구사항 페이지 하단의 서비스/Route 안내 참고: https://min.io/docs/minio/kubernetes/openshift/administration/bucket-replication/bucket-replication-requirements.html
...
- SSE 개요(리눅스): https://min.io/docs/minio/linux/operations/server-side-encryption.html
- SSE‑C: https://min.io/docs/minio/kubernetes/eks/administration/server-side-encryption/server-side-encryption-sse-c.html
- SSE‑S3: https://min.io/docs/minio/kubernetes/gke/administration/server-side-encryption/server-side-encryption-sse-s3.html
