---
layout: post
title: "05. RabbitMQ, Kafka, Redis를 함께 쓰는 실제 아키텍처와 Q&A"
...
## 7. 발표 Q&A: RabbitMQ 대신 Kafka를 쓰면 안 되나요?
...
## 8. 발표 Q&A: Kafka 대신 RabbitMQ를 쓰면 안 되나요?
...
## 9. 발표 Q&A: Redis Pub/Sub와 Kafka는 어떻게 다른가?
...
## 10. 발표 Q&A: Redis Streams와 Kafka는 어떻게 다른가?
...
## 11. 발표 Q&A: RabbitMQ는 Push고 Kafka는 Pull인가?
...
## 13. 발표 Q&A: Kubernetes에서는 왜 StatefulSet을 쓰나요?
